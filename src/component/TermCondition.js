...
function TermCondition() {
  ...
  <section className="terms-area section-tb-padding">
    <div className="container">
      <div className="row">
        <div className="col">
          ...
          <div className="terms-content">
            <ul className="terms-policy">
              <li>
                <h2>
                  <span>1.</span> What is Terms &amp; Conditions?
                </h2>
                <p className="trems-desc">
              ...
              <li>
                <h2>
                  <span>2.</span> How do we apply our Terms &amp; Conditions?
                </h2>
                <p className="trems-desc">
                  Lorem Ipsum is simply dummy text of the printing and
                  typesetting industry. Lorem Ipsum has been the industry's
              ...
              <li>
                <h2>
                  <span>3.</span> What personal data can you use?
                </h2>
                <p className="trems-desc">
                  Lorem Ipsum is simply dummy text of the printing and industry.
                </p>
                <p className="trems-desc">
                  Lorem Ipsum is simply Lorem Ipsum has been dummy text of the
                ...
                <p className="trems-desc">
                  Lorem Ipsum is simply dummy Lorem Ipsum has been text of the
                  printing and typesetting industry.
                </p>
                <p className="trems-desc">
