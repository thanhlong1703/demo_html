          ...
          <div className="login-area">
            <div className="login-box">
              ...
              <form>
                ...
                <a href="login" className="btn-style1">
                  Đăng nhập
                </a>
                <a href="forgot-password" className="re-password">
                  Quên mặt khẩu?
                </a>
              </form>
            </div>
            <div className="login-account">
              ...
              <a href="register" className="ceate-a">
                Tạo tài khoản
              </a>
              <div className="login-info">
                ...
                <p>
                Sự riêng tư và bảo mật của bạn không quan trọng đối với chúng tôi. Để biết thêm thông tin về cách chúng tôi sử dụng dữ liệu của bạn, hãy đọc{" "}
