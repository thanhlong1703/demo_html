        ...
        <div className="col-lg-3 col-md-4 col-12">
          <div className="all-filter">
            <div className="categories-page-filter">
              <h4 className="filter-title">Lọc</h4>
              <a
              ...
              <ul className="all-option collapse" id="category-filter">
                <li className="grid-list-option">
                  <input type="checkbox" />
                  <a href="javascript:void(0)">
                    Cà phê<span className="grid-items">(4)</span>
                  </a>
                </li>
                <li className="grid-list-option">
                  <input type="checkbox" />
                  <a href="javascript:void(0)">
                    Trà sữa<span className="grid-items">(6)</span>
                  </a>
                </li>
                <li className="grid-list-option">
                  <input type="checkbox" />
                  <a href="javascript:void(0)">
                    Đá xay <span className="grid-items">(8)</span>
                  </a>
                </li>
                <li className="grid-list-option">
                  <input type="checkbox" />
                  <a href="javascript:void(0)">
                    Trà hoa quả<span className="grid-items">(7)</span>
                  </a>
                </li>
                <li className="grid-list-option">
                  <input type="checkbox" />
                  <a href="javascript:void(0)">
                    Nước ép<span className="grid-items">(3)</span>
                  </a>
                </li>
              </ul>
            </div>
            <div className="price-filter">
              <h4 className="filter-title">Lọc theo giá</h4>
              <a
                href="#price-filter"
                data-bs-toggle="collapse"
                className="filter-link"
              ...
              <ul className="all-price collapse" id="price-filter">
                <li className="f-price">
                  <input type="checkbox" />
                  <label>30.00-50.000 <sup><small>đ</small></sup></label>
                </li>
                <li className="f-price">
                  <input type="checkbox" />
                  <label>50.000-100.000 <sup><small>đ</small></sup></label>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="col-lg-9 col-md-8 col-12">
            ...
            <div className="grid-list-select">
              <ul className="grid-list">
                ...
                <li className="colloction-icn three-grid">
                  <a href="grid-list" className="active">
          ...
          <div className="list-all-page">
            <div className="page-number">
              ...
              <a href="grid-list-2">2</a>
              <a href="grid-list-3">3</a>
              <a href="grid-list-4">4</a>
              <a href="javascript:void(0)">
