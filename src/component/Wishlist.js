            ...
            <div className="container">
                ...
                <div className="col">
                    ...
                    <div className="wishlist-details">
                        ...
                        <span className="wishlist-head">Mục ưa thích:</span>
                        <span className="wishlist-items">3 sản phẩm</span>
                        </div>
                        ...
                        <div className="wishlist-pro">
                            ...
                            <span className="all-size">
                                Size: <span className="pro-size">M</span>
                            </span>
                            </div>
                        </div>
                        <div className="qty-item">
                            <a href="cart" className="add-wishlist">
                            Thêm vào giỏ hàng
                            </a>
                            <a href="checkout" className="add-wishlist">
                            Mua ngay
                            </a>
                        </div>
                    ...
                    <div className="wishlist-details">
                        ...
                        <div className="wishlist-pro">
                            ...
                            <span className="all-size">
                                Size: <span className="pro-size">L</span>
                            </span>
                            </div>
                        </div>
                        <div className="qty-item">
                    ...
                    <div className="wishlist-details">
                        ...
                        <div className="wishlist-pro">
                            ...
                            <span className="all-size">
                                Size: <span className="pro-size">XL</span>
                            </span>
                            </div>
                        </div>
                        <div className="qty-item">
                        ...
                        <ul className="c-link">
                            ...
                            <a href="grid-list">Tiếp tục mua hàng</a>
                            </li>
                            <li className="wishlist-other-link">
                            <a href="index">Xóa ưa thích</a>
                            </li>
                        </ul>
                        </div>
                    </div>
                ...
                <div className="col">
                    ...
                    <div className="footer-link" id="footer-accordian">
                        ...
                        >
                            ...
                            <a href="grid-list">Fruits</a>
                            </li>
                            <li className="f-link-ul-li">
                            <a href="grid-list">Fast foods</a>
                            </li>
                            <li className="f-link-ul-li">
                            <a href="grid-list">Vegetable</a>
                            </li>
                            <li className="f-link-ul-li">
                            <a href="grid-list">Salads</a>
                            </li>
                            <li className="f-link-ul-li">
                            <a href="grid-list">Bestseller</a>
                            </li>
                        </ul>
                        </div>
                        <div className="f-link">
                        ...
                        >
                            <li className="f-link-ul-li">
                            <a href="about-us">About vegist</a>
                            </li>
                            <li className="f-link-ul-li">
                            <a href="faq%27s">Faq's</a>
                            </li>
                            <li className="f-link-ul-li">
                            <a href="contact">Contact us</a>
                            </li>
                            <li className="f-link-ul-li">
                            <a href="blog-style-1-3-grid">News</a>
                            </li>
                            <li className="f-link-ul-li">
                        ...
                        >
                            ...
                            <li className="f-link-ul-li">
                            <a href="tracking">Order history</a>
                            </li>
                            <li className="f-link-ul-li">
                            <a href="wishlist">My wishlist</a>
                            </li>
                            <li className="f-link-ul-li">
                            <a href="addresses">My address</a>
                            </li>
                        </ul>
                        </div>
                    </div>
