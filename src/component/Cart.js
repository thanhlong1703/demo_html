          ...
          <div className="cart-area">
            <div className="cart-details">
              <div className="cart-item">
                <span className="cart-head">Giỏ hàng:</span>
                <span className="c-items">3 sản phẩm</span>
              </div>
              <div className="cart-all-pro">
                <div className="cart-pro">
                  ...
                  <div className="pro-details">
                    ...
                    <span className="pro-size">
                      <span className="size">Size:</span> M
                    </span>
                    <span className="cart-pro-price">50.000 <sup><small>đ</small></sup></span>
                  </div>
                </div>
                <div className="qty-item">
                  <div className="center">
                    ...
                    <a href="grid-list" className="pro-remove">
                      Xóa
                    </a>
                  </div>
                </div>
              ...
              <div className="cart-all-pro">
                <div className="cart-pro">
                  ...
                  <div className="pro-details">
                    ...
                    <span className="pro-size">
                      <span className="size">Size:</span> L
                    </span>
                    <span className="cart-pro-price">50.000 <sup><small>đ</small></sup></span>
                  </div>
                </div>
              ...
              <div className="cart-all-pro">
                <div className="cart-pro">
                  ...
                  <div className="pro-details">
                    ...
                    <span className="pro-size">
                      <span className="size">Size:</span> XL
                    </span>
                    <span className="cart-pro-price">50.000 <sup><small>đ</small></sup></span>
                  </div>
                </div>
              ...
              <div className="other-link">
                <ul className="c-link">
                  <li className="cart-other-link">
                    <a href="grid-list">Cập nhật giỏ hàng</a>
                  </li>
                  <li className="cart-other-link">
                    <a href="grid-list">Tiếp tục mua hàng</a>
                  </li>
                  <li className="cart-other-link">
                    <a href="index">Làm mới giỏ hàng</a>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="col-xl-3 col-xs-12 col-sm-12 col-md-12 col-lg-4">
          <div className="cart-total">
            <div className="cart-price">
              <span>Tạm tính</span>
              <span className="total">150.000 <sup><small>đ</small></sup></span>
            </div>
            ...
            <div className="shop-total">
              <span>Tổng cộng</span>
              <span className="total-amount">150.000 <sup><small>đ</small></sup></span>
            </div>
            <a href="checkout" className="check-link">
              Thanh toán
            </a>
          </div>
        </div>
