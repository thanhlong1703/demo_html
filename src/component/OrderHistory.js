              ...
              <div className="order-his-page">
                <ul className="profile-ul">
                  <li className="profile-li">
                    <a href="order-history" className="active">
              ...
              <table className="table table-hover">
                ...
                <tbody>
                  <tr>
                    <td>78A643CD409</td>
                    <td>May 08, 2022</td>
                    <td className="canceled">Đã hủy</td>
                    <td>50.000 <sup><small>đ</small></sup></td>
                  </tr>
                  <tr>
                    <td>34VB5540K83</td>
                    <td>May 11, 2022</td>
                    <td className="process">Đang giao</td>
                    <td>50.000 <sup><small>đ</small></sup></td>
                  </tr>
                  <tr>
                    <td>78A643CD409</td>
                    <td>May 15, 2022</td>
                    <td className="delayed">Đang chuẩn bị</td>
                    <td>50.000 <sup><small>đ</small></sup></td>
                  </tr>
                  <tr>
                    <td>78A643CD409</td>
                    <td>May 18, 2022</td>
                    <td className="delivered">Hoàn thành</td>
                    <td>50.000 <sup><small>đ</small></sup></td>
                  </tr>
                  <tr>
                    <td>78A643CD409</td>
