            ...
            <div className="profile">
              <div className="order-pro">
                ...
                <div className="order-name">
                  ...
                  <span>Tham gia từ May 06, 2021</span>
                </div>
              </div>
              ...
              <form>
                ...
                <ul className="pro-input-label">
                  <li>
                    ...
                    <input type="text" name="name" placeholder="Mật khẩu mới" />
                  </li>
                  <li>
                ...
                <ul className="pro-submit">
                  <li>
                    ...
                    <label>Đăng ký nhận thông báo</label>
                  </li>
                  <li>
                    <a href="profile" className="btn btn-style1">
                      Cập nhật thông tin
                    </a>
                  </li>
                </ul>
